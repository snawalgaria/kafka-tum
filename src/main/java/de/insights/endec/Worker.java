...
public class Worker {
    ...
    protected SourceTaskOffsetCommitter sourceTaskOffsetCommitter;
    ...
    public boolean startTask(
        ...
        try {
            ...
            //log.info("line 420 "+readSecretFromVault());
            Map encryptConf = new HashMap<String, Integer>();
            encryptConf.put("encryption",config.getInt("encryption"));
            encryptConf.put("enctype",config.getString("enctype"));
            encryptConf.put("dectype",config.getString("dectype"));
            encryptConf.put("secretKey",config.getString("secretKey"));

            //Map encryptClass = new HashMap<String, String>();
            //encryptClass.put("enctype",config.getString("enctype"));
            log.info("404 "+config.getString("enctype"));
            //encryptConf.put("encryption", readSecretFromVault());
            keyConverter.configure(encryptConf,true);
           // keyConverter.configure(encryptClass,true);
            ...
            valueConverter.configure(encryptConf,false);
            //valueConverter.configure(encryptClass,false);
    ...
    public int readSecretFromVault() throws java.io.IOException, org.json.JSONException {
        String url1 = "http://127.0.0.1:8200/v1/secret/key";
        URL url;
        url = new URL(url1);
        HttpURLConnection httpUrl;
        httpUrl = (HttpURLConnection) url.openConnection();
        httpUrl.setRequestMethod("GET");
        httpUrl.setRequestProperty("X-Vault-Token", "87e3c3ef-c585-ab85-4628-863e1d5aa1bd");
        InputStream in;
